...
§
Hermes gateway: systemctl --user restart hermes-gateway.service. Pad ~/.hermes/hermes-agent/. CLI ~/.local/bin/hermes.
§
...
§
Obsidian vault: /mnt/c/Users/__BOOTSTRAP_WINDOWS_USER__/__BOOTSTRAP_OBSIDIAN_VAULT_SUBDIR__ (terminal.cwd). AI-output → 00-inbox/, nooit verwijderen/overschrijven. Templates in 05-templates/.
