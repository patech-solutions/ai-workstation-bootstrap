...
# AI Workstation - Firecrawl self-hosted bootstrap
# Target: WSL2 Ubuntu
#
# Purpose:
...
FIRECRAWL_ROOT="${FIRECRAWL_ROOT:-$HOME/.local/share/firecrawl}"
FIRECRAWL_REPO="${FIRECRAWL_REPO:-https://github.com/firecrawl/firecrawl.git}"
FIRECRAWL_PORT="${FIRECRAWL_PORT:-3002}"

echo "== AI Workstation: Firecrawl self-hosted bootstrap =="
...
# Auto-generated by bootstrap (07-firecrawl.sh) — do not edit.
services:
  playwright-service:
